...
function textbox(locals) {
  ...
  var textInputWrapperStyle = stylesheet.textbox.textInputWrapper.normal;
  var bottomTextStyle = stylesheet.textbox.bottomText.normal;
  ...
  if (locals.hasError) {
    ...
    textInputWrapperStyle = stylesheet.textbox.textInputWrapper.error;
    bottomTextStyle = stylesheet.textbox.bottomText.error;
  }
